...
5. Enter Markdown release notes explaining what changed in this version.
6. Select **Run workflow** to package and publish the release.
...
publishes the ZIP as the latest GitHub Release. The supplied notes are appended
to the standard description under **What changed**. The workflow runs only
through the manual `workflow_dispatch` button; commits and pushes do not
publish releases.
